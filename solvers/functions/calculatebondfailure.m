...
fail(fail == 1 & BONDTYPE == 1 & stretch > 1 * criticalStretchConcrete) = failureFunctionality;     % EMU user manual recommends that the critical stretch and bond force are multiplied by a factor of 3 for concrete to steel bonds 
