function [deformedLength,deformedX,deformedY,stretch] = calculatedeformedlength2D(deformedCoordinates,UNDEFORMEDLENGTH,deformedX,deformedY,nBonds,BONDLIST)
...
deformedLength = deformedX.^2 + deformedY.^2;    % Move outside of for loop - optimises speed
deformedLength = sqrt(deformedLength);           % sqrt outside of for loop - optimises speed

% Calculate bond stretch
stretch = (deformedLength - UNDEFORMEDLENGTH) ./ UNDEFORMEDLENGTH;
