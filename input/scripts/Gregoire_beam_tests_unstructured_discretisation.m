...
% ---------------------------------------
% TODO: calculate cell volumes correctly
% ---------------------------------------
...
Beam_4_structured_mesh;
undeformedCoordinates = msh.POS ./ 1000;
...
horizon = pi * 3/1000; % Be consistent - this is also known as the horizonRadius (pi * DX)
...
simulation.referenceNode = 35;               % Define a reference point/node for measuring deflections (18, 35, 70, 140)
simulation.CMOD = [25 45];                   % Define reference nodes for measuring CMOD ([10 25], [25 45], [50 90], [100 180])
