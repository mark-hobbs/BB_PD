...
Econcrete = 30.5e9; % 30.84e9;      % Young's modulus (remember to convert cubic test results to cylindrical equivalent) 
Esteel = 208e9;          % Young's modulus


%------------------------- Fracture Energy --------------------------------

fractureEnergyConcrete = 133; % 135.32;  % Fracture energy (N/m)
